          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Harshil Kumar `} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ ", a Full Stack-Web Developer", ", Competitive Coder", ", MERN Stack Developer" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <a href="https://drive.google.com/file/d/1ILCqsgyyakLNeu77iWyvqh_EFEsRtprh/view?usp=sharing">
